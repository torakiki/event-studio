...
/**
 * Annotated methods will be registered as Listener for the event in the method signature. Method signature must have a single parameter from which the event
 * class will be inferred. Multiple methods on the same pojo can be annotated.
 *
...
public @interface EventListener {
    ...
    /**
     * @return if true, the listener will be executed just once and then removed
     */
